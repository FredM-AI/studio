...
const SeasonCard = ({ season, eventCount, isAuthenticated }: { season: Season, eventCount: number, isAuthenticated: boolean }) => (
        ...
        <Card>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sortedSeasons.map((season) => {
            ...
            return <SeasonCard key={season.id} season={season} eventCount={eventCount} isAuthenticated={isAuthenticated} />;
          })}
        </div>
      )}
    </div>
